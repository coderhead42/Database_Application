...
VALUES
('$_REQUEST[fname]','$_REQUEST[lname]','$_REQUEST[join_date]','$_REQUEST[leave_date]','$_REQUEST[ssn]','$_REQUEST[sex]','$_REQUEST[bdate]','$_REQUEST[dno]','$_REQUEST[address]','$_REQUEST[phone_no]','$_REQUEST[super_ssn]','$_REQUEST[passcode]')";
}
if ($flag!=0 ||!mysql_query($sql))
	  {
header('Location:workers.php?message='.mysql_error());
		      }
else{
