...
$i=0;
while($i<$rows){
                $u_bill_no=mysql_result($ses_sql,$i,"bill_no");
...
$i=0;
while($i<$rows){
                $u_machine_id=mysql_result($ses_sql,$i,"machine_id");
                $u_date_purchase=mysql_result($ses_sql,$i,"date_purchase");
                $u_model_no=mysql_result($ses_sql,$i,"model_no");
                $u_dno=mysql_result($ses_sql,$i,"dno");
                echo "<table>
